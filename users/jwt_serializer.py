...
# The get_token method is overridden to add the username and email of the user to the token's payload. This allows the client to access these details directly from the token without needing to make additional API calls.
