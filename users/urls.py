...
from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView #TokenObtainPairView and TokenRefreshView are imported for handling JWT authentication
